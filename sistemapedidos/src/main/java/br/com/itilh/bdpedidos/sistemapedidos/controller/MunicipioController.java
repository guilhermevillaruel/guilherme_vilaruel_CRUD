...
public class MunicipioController {
    ...
    public Municipio postMunicipio(@RequestBody Municipio entity) throws Exception {
        try {
            ...
            throw new Exception("Não foi possível cadastrar o Município");
        }
    }

    @PutMapping("/municipio/{id}")
    public Municipio putEstado(@PathVariable BigInteger id, @RequestBody Municipio novosDados) throws Exception {
